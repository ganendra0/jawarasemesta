    ...
    <div class="pt-32 pb-20 px-4 sm:px-6 lg:px-8 bg-neutral">
        <div class="max-w-[1280px] mx-auto">
            ...
            <div class="text-center mt-16">
                <a href="{{ url('/#portfolio') }}" class="inline-flex items-center gap-2 border border-slate-gray text-slate-gray hover:bg-slate-gray hover:text-white px-6 py-3 rounded font-medium transition-colors">
